...
# --- ЦВЕТА СТАТУСОВ ---
STATUS_COLORS = {
    "not_registered": {"light": "#f7f8fa", "dark": "#15243c"},
    "registered": {"light": "#dbeafe", "dark": "#20497e"},
    "plus": {"light": "#c6f6d5", "dark": "#195347"},
    "banned": {"light": "#fed7d7", "dark": "#5d2633"},
    "invalid_password": {"light": "#e9d5ff", "dark": "#39315d"}
}
